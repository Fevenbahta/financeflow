...
var TransactionService = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        transaction = _a.sent();
                        if (!(data.type === "income")) return [3 /*break*/, 3];
                        return [4 /*yield*/, prisma_1.default.account.update({
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3:
                        if (!(data.type === "expense")) return [3 /*break*/, 5];
                        return [4 /*yield*/, prisma_1.default.account.update({
                                where: { id: data.accountId },
    ...
    TransactionService.prototype.getTransactions = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.repo.findByUser(userId)];
            });
        });
    };
    ...
    TransactionService.prototype.updateTransaction = function (id, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.repo.update(id, data)];
            });
        });
    };

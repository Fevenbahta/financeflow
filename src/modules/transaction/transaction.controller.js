...
var service = new transaction_service_1.TransactionService();
var createTransaction = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, transaction, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                userId = req.userId;
                return [4 /*yield*/, service.createTransaction(__assign(__assign({}, req.body), { userId: userId }))];
            case 1:
                transaction = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                userId = req.userId;
                return [4 /*yield*/, service.getTransactions(userId)];
            case 1:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!id)
                    return [2 /*return*/, res.status(400).json({ message: "Transaction ID is required" })];
                return [4 /*yield*/, service.deleteTransaction(id)];
            case 1:
                _a.sent();
...
var updateTransaction = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, updatedTransaction, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                if (!id)
                    return [2 /*return*/, res.status(400).json({ message: "Transaction ID is required" })];
                return [4 /*yield*/, service.updateTransaction(id, req.body)];
            case 1:

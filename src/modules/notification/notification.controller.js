...
var service = __importStar(require("./notification.service"));
var createNotification = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, notification, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                userId = req.userId;
                return [4 /*yield*/, service.createNotification(__assign(__assign({}, req.body), { userId: userId }))];
            case 1:
...
var getNotifications = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, notifications, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                userId = req.userId;
                return [4 /*yield*/, service.getNotifications(userId)];
            case 1:
